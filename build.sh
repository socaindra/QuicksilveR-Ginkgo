...
ZIPNAME="QuicksilveRV2-11-Ginkgo-KSU-$(TZ=Asia/Jakarta date +"%Y%m%d-%H%M").zip"
...
if ! git clone --depth=1 https://gitlab.com/vermouth/clang-r498229b.git ${TC_DIR}; then
...
elif ! git clone -q https://github.com/socaindra/AnyKernel3.git -b ginkgo-11; then
